...
exports.Initial1711752397763 = void 0;
class Initial1711752397763 {
    constructor() {
        this.name = 'Initial1711752397763';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "per_inf" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "objective" character varying NOT NULL, "email" character varying NOT NULL, "phone" character varying NOT NULL, "website" character varying NOT NULL, "location" character varying NOT NULL, "resumeid" integer, CONSTRAINT "REL_559ac5e4b1ca200bdec3659c5d" UNIQUE ("resumeid"), CONSTRAINT "PK_2c8a482af9369d5e41dd983e420" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "education" ("id" SERIAL NOT NULL, "school" character varying NOT NULL, "date" character varying NOT NULL, "degree" character varying NOT NULL, "gpa" character varying NOT NULL, "descriptions" character varying NOT NULL, "resumeid" integer, CONSTRAINT "PK_bf3d38701b3030a8ad634d43bd6" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "skills" ("id" SERIAL NOT NULL, "skill" character varying NOT NULL, "featuredSkill" integer NOT NULL, "resumeid" integer, CONSTRAINT "PK_0d3212120f4ecedf90864d7e298" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "res_set" ("id" SERIAL NOT NULL, "themeColor" character varying NOT NULL, "fontSize" character varying NOT NULL, "documentSize" character varying NOT NULL, "resumeid" integer, CONSTRAINT "REL_a2fad43f324c9b0ff1a028a98c" UNIQUE ("resumeid"), CONSTRAINT "PK_1086ebaec7819f0a8044ef9d622" PRIMARY KEY ("id"))`);
...
exports.Initial1711752397763 = Initial1711752397763;
//# sourceMappingURL=1711752397763-initial.js.map