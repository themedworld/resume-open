...
exports.PhotoModule = PhotoModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([photo_entity_1.Photo]), resume_module_1.ResumeModule,
        ],
        controllers: [photo_controller_1.UploadedFileController],
        providers: [photo_service_1.UploadedFileService],
    })
], PhotoModule);
